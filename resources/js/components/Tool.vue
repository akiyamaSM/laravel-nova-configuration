    ...
    <div>
        ...
        <card class="bg-90 flex flex-col items-center justify-center" style="min-height: 300px">
            ...
            <h1 class="text-white text-4xl text-90 font-light mb-6">
                We're in a black hole Bla Bla Bla.
            </h1>

            <p class="text-white-50% text-lg">
                You can edit this tool's component at:
                <code class="ml-1 border border-80 text-sm font-mono text-white bg-black rounded px-2 py-1">/nova-tools/LaravelNovaConfiguration/resources/js/components/Tool.vue</code>
            </p>
        </card>
    </div>
</template>
